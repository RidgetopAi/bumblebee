...
export function yellowA(text) {
    return colorize(text, 'yellowA');
}
export function yellowB(text) {
    return colorize(text, 'yellowB');
}
export function nearBlack(text) {
...
export function getThemeForConfig(trueColor) {
