 ...
 */
function renderCodeWithCliHighlight(code: string, lang: string): string {
  try {
...
*/
function addIndentationGuides(line: string, contentWidth: number, theme: BumblebeeTheme, useBlessedTags: boolean): string {
